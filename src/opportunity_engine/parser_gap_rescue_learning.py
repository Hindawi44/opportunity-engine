"""Conservative parser rescue learning from verified PARSER_GAP cases."""
...
from opportunity_engine.discovery.auksjonen_public_api_adapter import has_inventory_lot_signal
