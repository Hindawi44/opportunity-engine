...
def test_item_specific_clothing_lot_accepts_number_then_euro_symbol_price() -> None:
...
def test_item_specific_non_clothing_subject_is_not_polluted_by_navigation_text() -> None:
    classification, evidence = _classify_page(
