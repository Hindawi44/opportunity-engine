...
def test_verified_page_keeps_original_query_and_recovery_gets_no_query_credit(
    ...
    provenance._QUERY_BY_URL.clear()
    provenance._RECOVERY_URLS.clear()
    provenance._QUERY_BY_URL[DIRECT_URL] = "Deutschland Restposten Bekleidung Großhandel Lager"
    ...
    assert RECOVERY_URL in provenance._RECOVERY_URLS
...
def test_top5_selection_is_preserved_while_counts_separate_recovery(monkeypatch) -> None:
    provenance._RECOVERY_URLS.clear()
    provenance._RECOVERY_URLS.add(RECOVERY_URL)
    ...
    original = {
        ...
        "search_run_report": {"strict_exact_lot_count": 3, "top5_count": 1},
    }
