#!/usr/bin/env python3
"""Run the Germany Clothing Inventory discovery foundation."""
...
def main() -> int:
    ...
    parser.add_argument(
        "--output-dir",
        default="artifacts/germany-clothing-discovery",
    ...
    parser.add_argument(
        "--verify-pages",
        action="store_true",
        help="Read public HTTPS pages of the highest-ranked candidates",
    )
