...
from opportunity_engine.discovery.italy_market_discovery import collect_italy_market_signals


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Run bounded Italy clothing/bridal liquidation discovery."
    )
    parser.add_argument(
        "--output",
        default="artifacts/italy-market-discovery.json",
    ...
    report = collect_italy_market_signals(**kwargs)
